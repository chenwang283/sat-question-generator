...
Fill in every TODO, and replace the {{...}} fields (topic/skill slugs and labels) by hand when you copy this for a new skill.
When the file is complete, change `status` from PLACEHOLDER to `ready`.
-->

# Reading & Writing · {{Topic label}} · {{Skill label}}
